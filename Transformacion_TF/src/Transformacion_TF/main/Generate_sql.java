 ...
 *******************************************************************************/
package Transformacion_TF.main;
...
/**
 * Entry point of the 'Generate_sql' generation module.
 *
 * @generated
 */
public class Generate_sql extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/Transformacion_TF/main/generate_sql";
     ...
     * @generated
     */
    public Generate_sql(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Generate_sql(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Generate_sql generator = new Generate_sql(modelURI, folder, arguments);
